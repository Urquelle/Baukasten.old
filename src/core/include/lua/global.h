...
void wrapClasses()
{
	...
	SLB::Class<IncActions>("IncActions")
		.comment("IncActions Wrapper")
		.constructor()
		.set("addAction", &IncActions::addAction)
			.param("Action Object")
		.set("getAction", &IncActions::getAction)
			.param("ID of the Action")
		.set("getActions", &IncActions::getActions)
			.comment("Returns a Map of assigned Actions.")
		.set("hasAction", &IncActions::hasAction)
			.param("ID of the Action to look for")
		.set("invokeAction", &IncActions::invokeAction)
			.param("ID of the Action to invoke")
		.set("invokeActionOnTarget", &IncActions::invokeAction)
			.param("ID of the Action to invoke")
			.param("GameEntity Object as the target")
		.set("invokeActionOnTargets", &IncActions::invokeAction)
			.param("ID of the Action to invoke")
			.param("GameEntityList of Objects as targets")
		.set("dropAction", &IncActions::dropAction)
			.param("ID of the Action to drop from the execution queue")
		.set("runActions", &IncActions::runActions);
