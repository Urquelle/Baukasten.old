...
void wrapClasses()
{
	...
	SLB::Class<ActionsManager>("ActionsManager")
		...
		.constructor()
		.set("addAction", ( void (ActionsManager::*)(Action*) ) &ActionsManager::addAction)
			.param("Action Object")
		.set("addAction", ( void (ActionsManager::*)(const std::string&, Action*) ) &ActionsManager::addAction)
		...
		.set("invokeAction", ( void (ActionsManager::*)(const std::string&) ) &ActionsManager::invokeAction)
			.param("State Object")
		.set("invokeActionOnTarget", ( void (ActionsManager::*)(const std::string&, GameEntity*) ) &ActionsManager::invokeAction)
			.param("ID of the Action")
			.param("Target Object")
		.set("invokeActionOnTargets", ( void (ActionsManager::*)(const std::string&, GameEntityList) ) &ActionsManager::invokeAction)
			.param("ID of the Action")
			.param("Target List")
